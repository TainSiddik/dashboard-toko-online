                ...
                <div className="management flex items-center justify-between">
                    <div className="menu flex items-center gap-4">
                        ...
                        <div className="namaKategori font-semibold">
                            <h1 className="text-lg text-teal-600">Managemen Produk</h1>
                        </div>
                    </div>
                    <div className="tambahProduk flex items-center">
                        <Link to={'/tambah'} className="bg-teal-500 bg-opacity-0 px-4 py-1 rounded-md ring-2 ring-teal-300 text-teal-600 font-semibold hover:bg-opacity-80 hover:text-white transition-all duration-300 ease-in-out">Tambah Produk</Link>
                    </div>
                </div>
                <hr className="my-3 border-teal-500" />
                <div className="allProduk">
                    <div className="find flex justify-between items-center">
                        <div className="kategori flex gap-4 items-center">
                            <div className="icon flex items-center">
                                <button>
                                    <i className="fa-solid fa-bars text-teal-700"></i>
                                </button>
                            </div>
                            <div className="namaKategori font-semibold">
                                <h1 className="text-teal-600">Kategori</h1>
                            </div>
                        </div>
                        <div className="search">
                            <div className="findProduk flex gap-2 ring-2 ring-teal-500 rounded-md items-center px-2 py-1">
                    ...
                    <div className="listProduk grid grid-cols-5 gap-4 mt-8 mb-4">
                        {produk.map((p) => (
